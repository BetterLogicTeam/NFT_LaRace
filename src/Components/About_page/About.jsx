                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-6 order-lg-1 order-sm-12 text-left">
                            <h1 class="section-title">About<span class="subtitle">LR Race</span></h1>
                            <p class="section-subtitle">Learn More About Us</p>
                            <p class="section-description">LR Race (Lr Galaxy) is a racing game with futuristic mythological styling. Pega (the horses) are descendants of the mighty Pegasus. In this game, players will participate in PvP format races to win rewards in the platforms native utility token, VIS (Vigorus).</p>
                    ...
                    <div class="feature-box">
                        ...
                        <div class="feature-item">
                            <div class="entry-content">
                                ...
                                <p class="entry-description">If you plan to be a manager, there’s no need for manual scholar payments and multiple wallets. Everything in LR Race is handled via escrow automatically. It’s safe, transparent and fast for everyone.</p>
                            </div>
                        </div>
                    </div>
                </div>
